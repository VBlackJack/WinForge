...
public interface IApplicationBridge
{
    ...
    /// <summary>
    /// Installs multiple applications in batch.
    /// </summary>
    /// <param name="apps">List of applications to install</param>
    /// <param name="isDryRun">If true, simulates installation without making changes</param>
    /// <param name="parallelism">Number of parallel installations</param>
    /// <param name="progress">Optional progress reporting</param>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Batch installation result</returns>
    Task<BatchInstallResult> InstallApplicationsAsync(
...
/// </summary>
public record BatchInstallResult
{
    /// <summary>
    /// Number of applications successfully installed.
    /// </summary>
    public int SuccessCount { get; init; }

    /// <summary>
    /// Number of applications that failed to install.
    /// </summary>
    public int FailureCount { get; init; }

    /// <summary>
    /// Number of applications skipped (already installed).
    /// </summary>
    public int SkippedCount { get; init; }

    /// <summary>
    /// Individual results for each application.
    /// </summary>
    public required IReadOnlyList<InstallResult> Results { get; init; }
...
/// <summary>
/// Progress information for batch installation.
/// </summary>
public record BatchInstallProgress
{
    /// <summary>
    /// Current application being processed.
    /// </summary>
    public required string CurrentApp { get; init; }

    /// <summary>
    /// Index of current application (1-based).
    /// </summary>
    public int CurrentIndex { get; init; }

    /// <summary>
    /// Total number of applications to process.
    /// </summary>
    ...
    /// </summary>
    public int PercentComplete => TotalCount > 0 ? (int)((CurrentIndex * 100.0) / TotalCount) : 0;
}
