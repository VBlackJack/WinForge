...
public sealed class ThemeService : IThemeService
{
    ...
    internal static void ApplyPaletteBridgeResources(ResourceDictionary resources)
    {
        ...
        SetBrush(resources, "ErrorBackgroundBrush", CloneBrush(error, 0.14));
        ...
        SetBrush(resources, "WarningBackgroundBrush", CloneBrush(warning, 0.16));
        ...
        SetBrush(resources, "SuccessBackgroundBrush", CloneBrush(success, 0.12));
