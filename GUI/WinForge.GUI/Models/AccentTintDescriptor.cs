...
/// <summary>
/// Immutable descriptor of an accent tint registered with <c>IThemeService</c>.
/// </summary>
/// <param name="Name">Canonical accent tint name used as the persisted settings value.</param>
