...
| Big-bang PR diff size makes review harder | High | Low | Mitigated by clear ADR + structured review notes. Reviewer can take palettes en bloc (mechanical), service + tests separately (logic). |
