<#
.SYNOPSIS
    PSScriptAnalyzer validation for Win11Forge v2.5.0
...
Write-Host "  Win11Forge v2.5.0 - PSScriptAnalyzer" -ForegroundColor Cyan
Write-Host "═══════════════════════════════════════════════" -ForegroundColor Cyan
Write-Host ""
...
<head>
    <meta charset="utf-8">
    <title>PSScriptAnalyzer Report - Win11Forge v2.5.0</title>
    <style>
...
<body>
    ...
    <p><strong>Win11Forge Framework v2.5.0</strong></p>
