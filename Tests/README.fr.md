...
Mesure du 2026-09-06 : 1978 tests Pester, 1972 réussis, 0 échec et 6 ignorés. La version du framework est `2026090601`, définie dans `Config/version.json`. Les résultats habituels sont écrits dans `Tests/Results/`. Ces nombres décrivent une exécution, pas une contrainte sur le nombre futur de tests.
